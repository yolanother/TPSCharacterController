...
namespace DoubTech.TPSCharacterController.Inputs.InputMethods.Mirror
{
    ...
    /// </remarks>
    [AddComponentMenu("Network/TPSNetworkAnimator")]
    [RequireComponent(typeof(NetworkIdentity))]
    [HelpURL("https://mirror-networking.com/docs/Components/NetworkAnimator.html")]
    public class TPSNetworkAnimator : NetworkBehaviour
    {
        static readonly ILogger logger = LogFactory.GetLogger(typeof(global::Mirror.NetworkAnimator));
        ...
        public override bool OnSerialize(NetworkWriter writer, bool initialState)
        {
            if (initialState)
            {
                for (int i = 0; animator && i < animator.layerCount; i++)
                {
